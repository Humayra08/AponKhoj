...
import {
    ...
    ChevronRight, Menu, X, UserCheck, RefreshCw, Loader2, Search
} from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 shadow-sm">
                    <button onClick={() => setMobileOpen(true)} className="p-2 text-gray-500 hover:text-gray-700">
                        <Menu size={20} />
                    </button>
                    <span className="font-black text-sm text-gray-800">অ্যাডমিন প্যানেল</span>
                    <Bell size={18} className="text-gray-400" />
                </div>

                {/* Desktop top bar */}
                <div className="hidden lg:flex items-center justify-between px-6 py-3 bg-white border-b border-gray-100">
                    <div className="flex items-center gap-2 text-xs text-gray-400">
                        <Shield size={13} className="text-red-500" />
                        <span className="font-bold text-red-500">ADMIN</span>
                        <span>/</span>
                        <span className="capitalize text-gray-600 font-semibold">{activeSection}</span>
                    </div>
